    ...
    <style>
      * {
      ...
      .left {
        ...
        line-height: 30px;
        color: #fff;
        background-color: rgba(200, 40, 156, 0.6);
      }
      .right {
        position: absolute;
        width: 30px;
    ...
    <script>
      ...
      function lazyLoad() {
        ...
        for (var i = n; i < oImgs.length; i++) {
          if (
            my.getEleToDoc(oImgs[i]).top <=
            my.getWinScroll().top + my.getScreen().height
          ) {
    ...
    <script>
      ...
      oInner.onmousedown = function (e) {
        ...
        document.onmousemove = function (e) {
          ...
          var conmoveTop =
            (oCon.offsetHeight - document.documentElement.clientHeight) * scale;
          oInner.style.top = mouseMoveTop + 'px';
